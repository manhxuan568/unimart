...
<div class="row main-content-wp no-gutters">
    <div class="col-md-3 sidebar pl-0">
            ...
            <!-- // -->
            <div class="section fillter-product-wp" id="fillter-wp" data-slug="{{ request()->slug?request()->slug:'' }}" data-link="http://localhost/Project-Laravel/unimart">
                <div class="title-section">
    ...
    <!-- //end-sideber -->
    <div class="col-md-9 content pl-lg-4 pl-md-2">
        <div class="section featured-p-wp" id="list-products-cat-wp"> 
            ...
            <div class="body-section" id="list-products-phone">
                ...
                @foreach ($products as $item)
                    <div class="item-p">
                        <a href="{{ route('productDetail',$item->slug) }}" class="item-links">
                            ...
                            <div class="item-link-buy">
                                <a href="" class="link add-card art-to-cart" data-slug="{{ $item->slug }}">Thêm giỏ hàng</a>
                                <a href="{{ route('buyNow',$item->id) }}" class="link buy-now">Mua ngay</a>
                            </div> 
                        </a>
                    </div> 
                @endforeach     
                @else
                <p style="font-size: 17px">Không tìm thấy sản phẩm nào.</p>
                <div class="search-empty">
                    <lottie-player id="firstLottie" src="https://assets6.lottiefiles.com/packages/lf20_cwzd46cu.json" style="width:300px; height: 300px;" hover loop autoplay>"></lottie-player> 
                </div>    
                @endif
            </div>
             {{ $products->appends($filter_paginate)->links() }}
        </div>              
    </div>
</div>
</div>
